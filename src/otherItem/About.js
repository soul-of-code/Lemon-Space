...
import { FireOutlined, CommentOutlined, BorderlessTableOutlined, ArrowLeftOutlined } from '@ant-design/icons'
                    ...
                    <Col xs={24} sm={24} md={24} lg={17} xl={17} id='main-left'>
                        <div className="about-wrap">
                            ...
                            <div className="about-line">
                                李明聪，男，一个爱吉他爱篮球爱唱歌的伪全能程序员。性格开朗外向。分享一些我对于技术上的理解，对于人生上的感悟，还有我的小故事。
                            </div>
                            <div className="about-line">
                                上文的外向指的是上了高中以后的李明聪，在这之前，李明聪就是个伪自闭症患者，内向自卑，不敢与人交流，被打不敢还手，被骂不敢还口，一个校园暴力受害者（详见小故事）。
                            </div>
                            <div className="about-line">
                            ...
                            <h2>关于 头像里的女人</h2>
                            <div className="about-line">
                                kyn ， 女的，2018年我的陪聊对象，2020年我生命的一半。智力低下，没有脾气。
                            </div>
                            <div className="about-line">
                                在遇见她之前我从来没有想过一个女孩子脾气可以这么好，我也从来没想过能有一个女孩子跟我的一切都那么切合，我跟她在任何方面都没有任何的矛盾，但是她要去读研，我要去工作，我本想努力跟她在一个城市，但是我还是顺从她的想法，一切看缘分。
                            </div>
                            <h2>关于 聪霸霸语录</h2>
                            <div className="about-line">
